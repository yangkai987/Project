package com.membership_score.baselib.image.okhttpprogress;
...
public class ProgressManager {
    ...
    private static final OnProgressListener LISTENER = new OnProgressListener() {
        @Override
        public void onProgress(String imageUrl, int percent, long bytesRead, long totalBytes, boolean isDone, GlideException exception) {
            ...
            for (int i = 0; i < listeners.size(); i++) {
                ...
                if (progressListener == null) {
                    ...
                    progressListener.onProgress(imageUrl, percent, bytesRead, totalBytes, isDone, exception);
                }
            }
        }
    };
