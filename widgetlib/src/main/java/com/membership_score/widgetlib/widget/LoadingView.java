...
public class LoadingView extends FrameLayout {
    ...
    public LoadingView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            mBottomPadding = ta.getDimensionPixelOffset(R.styleable.LoadingView_loading_bottom_padding, 0);
            ta.recycle();
        }
    }
    ...
    protected void onFinishInflate() {
        ...
        mLoadingView = View.inflate(mContext, R.layout.loadingview_loading, null);
        mErrorView = View.inflate(mContext, R.layout.loadingview_error, null);
        mEmptyView = View.inflate(mContext, R.layout.loadingview_empty, null);
        mIntentErrorView = View.inflate(mContext, R.layout.loadingview_intent_error, null);
