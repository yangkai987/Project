package com.membership_score.widgetlib.widget;
...
import com.membership_score.widgetlib.R;
...
public class RoundImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            int allRadius = ta.getDimensionPixelOffset(R.styleable.RoundImageView_all_radius, 0);

            int topLeftRadius = ta.getDimensionPixelOffset(R.styleable.RoundImageView_top_left_radius, 0);
            topLeftRadius = topLeftRadius > 0 ? topLeftRadius : allRadius;
            rids[0] = topLeftRadius;
            rids[1] = topLeftRadius;

            int topRightRadius = ta.getDimensionPixelOffset(R.styleable.RoundImageView_top_right_radius, 0);
            topRightRadius = topRightRadius > 0 ? topRightRadius : allRadius;
            rids[2] = topRightRadius;
            rids[3] = topRightRadius;

            int bottomRightRadius = ta.getDimensionPixelOffset(R.styleable.RoundImageView_bottom_right_radius, 0);
            bottomRightRadius = bottomRightRadius > 0 ? bottomRightRadius : allRadius;
            rids[4] = bottomRightRadius;
            rids[5] = bottomRightRadius;

            int bottomLeftRadius = ta.getDimensionPixelOffset(R.styleable.RoundImageView_bottom_left_radius, 0);
