 ...
 * 会员积分列表
 */
public class MemberShipScoreNumResult implements Serializable {
    ...
    public MemberShipScoreNumResult(Integer user_id, Integer membership_score_pay_money_num, Integer membership_score_get_num, String membership_score_pay_time, Integer ms_pay_type) {
